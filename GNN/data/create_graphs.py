...
# if len(sys.argv) < 10:
#     print("Order: create_graphs.py data_path(PAGE-XML) dir_dest minradio min_num_neighbours weight_radius_w weight_radius_h j_h j_w max_width_line")
#     print(sys.argv , len(sys.argv))
#     exit()
# dir = sys.argv[1]
# dir_dest = sys.argv[2]
# minradio = float(sys.argv[3]) # minium num of cells to calculte length
...
# if len(sys.argv) > 11:
#     data_path_tablelabel = sys.argv[11]
# else:
#     data_path_tablelabel = ""
